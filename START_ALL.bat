@echo off
echo ========================================
echo    RUBBERFLEX - Demarrage Complet
echo ========================================
echo.

echo [1/3] Demarrage du Backend...
start "RUBBERFLEX Backend" cmd /k "cd backend && node server.js"
timeout /t 3 /nobreak > nul

echo [2/3] Demarrage du Frontend...
start "RUBBERFLEX Frontend" cmd /k "npm run dev"
...
echo Interface Admin: http://localhost:5173/admin
